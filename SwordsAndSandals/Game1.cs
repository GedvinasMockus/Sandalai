...
namespace SwordsAndSandals
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            player1 = new Player(Content.Load<Texture2D>("Character/Ninja/Kunoichi/Run"), new Vector2(_screenWidth / 6, _groundLevel), 3.0f, availableAbilities1, 95);
            ...
            player2 = new Player(Content.Load<Texture2D>("Character/Ninja/Ninja_Monk/Idle"), new Vector2(5 * _screenWidth / 6, _groundLevel), 3.0f, availableAbilities2, 58);
